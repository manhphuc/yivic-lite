 ...
 * `Yivic\YivicLite` root namespace.
 *
...
if ( ! class_exists( 'YivicLite_Theme_Autoloader', false ) ) {

    /**
     * Class YivicLite_Theme_Autoloader
     *
     * Minimal PSR-4 style autoloader with support for multiple
     * namespace prefixes. The `Yivic\YivicLite\` root namespace
    ...
    class YivicLite_Theme_Autoloader {
         ...
         * Example:
         *  [
         *      'Yivic\\YivicLite\\' => '/path/to/theme/src/'
         *  ]
         *
        ...
        public static function register(): void {
            ...
            // PSR-4 mapping:
            //   Yivic\YivicLite\*  =>  src/*
            static::addNamespace( 'Yivic\\YivicLite\\', $baseDir );
    ...
    YivicLite_Theme_Autoloader::register();
}